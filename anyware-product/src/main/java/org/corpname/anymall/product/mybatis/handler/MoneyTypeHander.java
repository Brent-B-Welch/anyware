package org.corpname.anymall.product.mybatis.handler;
 ...
 * @projectName: anyware
 * @version: v0.0.1
 * @className: MoneyTypeHander
 * @packageName: org.corpname.anymall.product.mybatis.handler
 * @description: TODO Class description
 * @author: Beiji Ma
 * @date: 2021-12-15 23:32
 **/
public class MoneyTypeHander extends BaseTypeHandler<Money> {
    @Override
    public void setNonNullParameter(PreparedStatement preparedStatement, int i, Money money, JdbcType jdbcType) throws SQLException {
        preparedStatement.setLong(i, money.getAmountMajorInt());
    }
